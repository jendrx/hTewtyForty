...
class PreviewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'previews_round_question_indicator_id_fkey' => ['type' => 'foreign', 'columns' => ['round_question_indicator_id'], 'references' => ['rounds_questions_indicators', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
